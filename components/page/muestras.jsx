...
const Muestras = () => {
  ...
  useEffect(() => {
    ...
    if (selectedStatus) {
      filteredmuestras = filteredmuestras.filter(
        (muestra) => muestra.estado === selectedStatus
      );
    }
          ...
          {filteredData.map((muestra) => (
            ...
            >
              ...
              <View style={sharedStyles.contenedorBtn}>
                <View style={sharedStyles.itemContainer}>
                  <TouchableOpacity
                    onPress={() => vista("Actualizar", muestra, muestra.codigo)}
                ...
                <View style={sharedStyles.buttonContainerD}>
                  <TouchableOpacity
                    onPress={() =>
                      muestra.estado === "activo"
                        ? handleDesactivar(muestra.codigo)
                        : handleActivar(muestra.codigo)
                    }
                    style={
                      muestra.estado === "activo"
